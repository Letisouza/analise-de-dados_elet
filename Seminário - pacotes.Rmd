...
2- O segundo passo é editar o arquivo _DESCRIPTION_ com a informação do pacote desejado. Nesse caso, indicando a importação com o nome do pacote e a versão dele.
...
Para utilizar variáveis de bases em pacotes externos, você vai precisar utilizar também a abordagem _double colon_, que permite acessar variáveis exportadas e incorporar em um namespace, que é utilizado da seguinte maneira:
